...
| `tone`    | 意味                        | Coordinate     | Resurface (節目記念日) | Cast (.md 火種コメント)      |
| --------- | --------------------------- | -------------- | ---------------------- | ---------------------------- |
| `neutral` | 中立な事実 (例: サイト開設) | 表示する       | 表示する               | 表示する (素のラベル)        |
| `light`   | 軽めの節目 (例: 復帰)       | 表示する       | 表示する               | 表示する (素のラベル)        |
| `heavy`   | 重い節目 (例: 喪失体験)     | **表示しない** | **表示しない**         | 表示する (`[重い節目]` 付き) |
