...
v1 の `01-concept-and-personas.md` 〜 `09-glossary-and-decisions.md` は本 PR で削除済みであり、Phase1 着手は本ドキュメントを **唯一の単一ソース** とする。
...
- エントリポイント: [README.md](./README.md)
- Epic Issue: [#386](https://github.com/amkkr/lazy-note/issues/386)

> v1 RFC (`01-concept-and-personas.md` 〜 `09-glossary-and-decisions.md`) は本 PR で削除済み。設計合意は本ドキュメントに集約されている。
