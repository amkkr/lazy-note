...
- [`docs/rfc/editorial-citrus/10-renewal-phase1-plan.md`](../../docs/rfc/editorial-citrus/10-renewal-phase1-plan.md) の「R-1: フォント実適用 (Newsreader VF + 日本語スタック)」節 (タイポグラフィ全体方針 / フォントスタック定義 / ロードマップ上の位置づけ)
- [`docs/rfc/editorial-citrus/README.md`](../../docs/rfc/editorial-citrus/README.md) (Editorial Citrus リニューアルのエントリポイント)
